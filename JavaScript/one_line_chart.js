...
// 创建单数据折线
function LineChart(arg, options) {
...
// 继承Chart的方法
inheritPrototype(LineChart, Chart);
...
// 绘制X轴刻度
LineChart.prototype.drawXMark = function() {
    var opt = this.options;
...
// 绘制Y轴
LineChart.prototype.drawYMark = function() {
...
// 数据转换为坐标点
LineChart.prototype.coordinatePointTranslate = function(value, attr) {
    var point = [],
        data = value;
...
// 绘制数据点
LineChart.prototype.drawDot = function(value) {
    var data = value;
...
// 绘制折线
LineChart.prototype.drawLine = function(value) {
    var data = value,
        opt = this.options;
