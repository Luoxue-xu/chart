...
// 创建股票分时图
function StockMinuteChart(arg, options) {
...
// 继承Chart的方法
inheritPrototype(StockMinuteChart, Chart);

// 创建基本信息
StockMinuteChart.prototype.initialize = function() {
...
// 绘制X轴刻度
StockMinuteChart.prototype.drawXMark = function() {
    var opt = this.options;
...
// 绘制Y轴
StockMinuteChart.prototype.drawYMark = function() {
...
// 数据转换为坐标点
StockMinuteChart.prototype.coordinatePointTranslate = function(value, attr) {
    var point = [],
        data = value;
...
// 绘制数据点
StockMinuteChart.prototype.drawDot = function(value) {
    var data = value;
...
// 绘制折线
StockMinuteChart.prototype.drawLine = function(value) {
    var data = value,
        opt = this.options;
